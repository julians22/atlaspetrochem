...
@section('title', 'Main Category Management | Edit Main Category')

@section('content')
    {{ html()->modelForm( $category, 'PATCH', route('admin.product.main-category.update', $category->id))->class('form-horizontal')->open() }}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted">Edit Main Category</small>
                        </h4>
                    </div><!--col-->
                </div><!-- row -->
                            ...
                            {{ html()->label('Thumbnail Image')->class('col-md-2 form-control-label')->for('thumbnailImageField') }}
                                <div class="col-md-10">
                                    <div class="input-group">
                                        {{ html()->text('image_location')->id('thumbnailImageField')->class('form-control')->placeholder('Thumbnail Image')->readonly() }}
                                    ...
                                    <small class="text-muted">Recommended size 300 x 400 pixels, max file size 5mb, png file type with no background</small>
                                </div>
                        </div>
            ...
            <div class="card-footer clearfix">
                <div class="row">
                    <div class="col">
                        {{ form_cancel(route('admin.product.main-category.index'), __('buttons.general.cancel')) }}
                    </div><!--col-->
