...
@section('title', 'Slider Team Management | Edit Slider Team')
...
@section('content')
    {{ html()->modelForm( $slider, 'PATCH', route('admin.slider.teams.update', ['teams' => $slider]))->class('form-horizontal')->open() }}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted">Edit Slider Team</small>
                        </h4>
                    </div><!--col-->
                </div><!-- row -->
            ...
            <div class="card-footer clearfix">
                <div class="row">
                    <div class="col">
                        {{ form_cancel(route('admin.slider.teams'), __('buttons.general.cancel')) }}
                    </div><!--col-->
