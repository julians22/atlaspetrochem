...
@section('title', app_name() . ' | Slider Company')
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    Slider Company Management <small class="text-muted">Active Sliders</small>
                </h4>
            </div><!--col-->
                    ...
                    <table class="table">
                        ...
                        @foreach($sliders as $slider)
                            <tr>
                                ...
                                <td>@include('backend.slider.company.includes.active', ['slider' => $slider])</td>
                                <td>{{ $slider->created_at->diffForHumans() }}</td>
                                <td>{{ $slider->updated_at->diffForHumans() }}</td>
                                <td>
                                    @include('backend.slider.company.includes.actions', ['slider' => $slider])
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
