...
@section('content')
    <section class="py-6" data-aos="fade-up" data-aos-duration="2000">
        <h4 class="text-2xl font-bold text-center tracking-widest">@lang('labels.frontend.leading-lubs.title')</h4>
        <h5 class="text-xl font-semibold text-gray-800 text-center tracking-widest">@lang('labels.frontend.leading-lubs.sub-title')</h5>
