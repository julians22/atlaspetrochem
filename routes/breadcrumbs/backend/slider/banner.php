...
Breadcrumbs::for('admin.slider.banner', function ($trail) {
    $trail->push('Slider Home Management', route('admin.slider.banner'));
});

Breadcrumbs::for('admin.slider.banner.create', function ($trail) {
    $trail->parent('admin.slider.banner');
    $trail->push('Create Slider Home', route('admin.slider.banner.create'));
});

Breadcrumbs::for('admin.slider.banner.edit', function ($trail, $banner) {
    $trail->parent('admin.slider.banner');
    $trail->push('Edit Slider Home', route('admin.slider.banner.edit', ['banner' => $banner]));
});

Breadcrumbs::for('admin.slider.banner.deleted', function ($trail) {
    $trail->parent('admin.slider.banner');
    $trail->push('Deleted Slider Home', route('admin.slider.banner.deleted'));
});
...
Breadcrumbs::for('admin.slider.company.deleted', function ($trail) {
    $trail->parent('admin.slider.company');
    $trail->push('Deleted Company Slider', route('admin.slider.company.deleted'));
});
