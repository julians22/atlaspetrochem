...
class CategoryController extends Controller
{
    ...
    {
        return view('backend.products.categories.edit')->with('category', $category);
    }
    ...
    public function update(UpdateCategoryRequest $request, Category $category)
    {
        ...
        return redirect()->route('admin.product.category.index')->withFlashSuccess('suceess updated');
    }
